...
import emojiToolkit, { toShort, emojiList as emojiList$2, toImage, shortnameToImage } from 'emoji-toolkit';
...
var mapShortnameToUnicode = Object.fromEntries(data.map(function (item) {
  return [toShort(item.unicode), item.unicode];
}));
...
var EmojiSelect = /*#__PURE__*/function (_Component) {
  ...
  function EmojiSelect() {
    ...
    _this.emojiSelectRef = /*#__PURE__*/React.createRef();
