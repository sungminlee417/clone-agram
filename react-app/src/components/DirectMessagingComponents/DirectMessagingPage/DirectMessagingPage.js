...
const DirectMessagingPage = () => {
  ...
  return (
    <section className="direct-messaging-page-container">
                ...
                {Object.values(directMessage.members).length > 1 ? (
                  <div className="direct-messaging-message-link-user-profile-two">
                    <img
                      ...
                      src={
                        Object.values(directMessage.members)[0].user.profileImg
                      }
                    ...
                    <img
                      ...
                      src={
                        Object.values(directMessage.members)[1].user.profileImg
                      }
                      ...
                      return (
                        ...
                        >
                          <div className="direct-messaging-message-user-name">
                            ...
                            {i <
                              Object.values(directMessage.members).length - i &&
                              i > 0 &&
                              `, ${member.user.name}`}
                          </div>
                        </div>
